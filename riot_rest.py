...
def summoner():
    ...
    u = urllib2.urlopen("https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/"+sname+"?api_key=RGAPI-959e2042-67bf-4d8e-abc4-42dba6e5fb40")
    d = u.read()
    summ_dict = json.loads(d)
    name = summ_dict['name']
    accountId = summ_dict['accountId']
    summId = summ_dict['id']
    u2 = urllib2.urlopen("https://na1.api.riotgames.com/lol/league/v3/positions/by-summoner/"+str(summId)+"?api_key=RGAPI-959e2042-67bf-4d8e-abc4-42dba6e5fb40")
    d2 = u2.read()
